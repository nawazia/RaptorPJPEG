...
void readScans(BitReader& bitReader, JPGImage* const image) {
    ...
    const std::string outpath = "/Users/i/Downloads/DNA_STorage/code/jpeg/data/DC.bmp";
...
void decodeHuffmanData(BitReader& bitReader, JPGImage* const image) {
    ...
    // decode one full MCU. In the case of subsampling, one MCU can be 8x8, 16x8, 8x16, 16x16.
